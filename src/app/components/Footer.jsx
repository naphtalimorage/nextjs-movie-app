    ...
    <footer className="relative w-full border-t-2 bg-black ">
      <div className="mx-auto w-full max-w-7xl px-8 mt-5">
        ...
        <div className="mt-5 flex w-full flex-col items-center justify-center  py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-serif font-normal text-blue-gray-500 md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">SteamFilm</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-500 sm:justify-center mr-20">
            ...
            <Typography as="a" href="https://x.com/naphtalimorage" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
